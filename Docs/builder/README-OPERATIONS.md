...
- `fb-main-profile` and `fb-main-page` both point at the `SanguineQueen` personal Facebook lane. Treat that lane as opt-in, weekends-only by default, and capped at `3/week`.

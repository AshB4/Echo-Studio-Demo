...
This document describes the intended Linux deployment model for PostPunk.

Some implementation details may evolve. If runtime behavior and this document disagree, verify the current code and service definitions.

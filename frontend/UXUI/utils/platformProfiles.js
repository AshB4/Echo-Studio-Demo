export const platformProfiles = {
  ...
  kofi: {
    ...
    bestFormats: ["lore fragment", "church announcement", "ritual note", "diary fragment"],
    structureRules: [
    ...
    openerPatterns: [
      "A whispered transmission",
      "A church notice",
      "A diary fragment from the universe",
    ],
    notes: [
      "Support context should feel mythic and relational, not corporate.",
      "Best when the post feels saveable, rereadable, and emotionally charged.",
    ],
    sourceNotes: ["Creator-support product norms adapted for fictional-universe publishing."],
  },
  amazon: {
    id: "amazon",
    label: "Amazon",

...
export function normalizeContentMetadata(metadata = {}, overrides = {}) {
	...
	const normalized = {
		...
		coverImagePrompt: toCleanString(source.coverImagePrompt),
		coverImagePromptFields: toPlainObject(source.coverImagePromptFields),
		coverImageUrl: toCleanString(source.coverImageUrl),
		coverImageAlt: toCleanString(source.coverImageAlt),
		coverImageSource: toCleanString(source.coverImageSource),
		coverImageStatus: toCleanString(source.coverImageStatus),
		...
		identityArchetype: toCleanString(source.identityArchetype),
		ecosystemCluster: toCleanString(source.ecosystemCluster),
		futureSelfSignal: toCleanString(source.futureSelfSignal),
		saveReason: toCleanString(source.saveReason),
		utilityType: toCleanString(source.utilityType),
		discoveryScore: toNumber(source.discoveryScore),
		retailCommonalityScore: toNumber(source.retailCommonalityScore),
		rabbitHoleScore: toNumber(source.rabbitHoleScore),
		visualClarityScore: toNumber(source.visualClarityScore),
		savePotentialScore: toNumber(source.savePotentialScore),
		amazonDiscoveryScore: toNumber(source.amazonDiscoveryScore),
		seasonalityScore: toNumber(source.seasonalityScore),
		landingPageMatchScore: toNumber(source.landingPageMatchScore),
		landingPageMatchReason: toCleanString(source.landingPageMatchReason),
		productFitScore: toNumber(source.productFitScore),
		productFitState: toCleanString(source.productFitState),
		productFitReasons: toStringArray(source.productFitReasons),
		productFitRecommended: typeof source.productFitRecommended === "boolean" ? source.productFitRecommended : null,
		productFitBlocked: typeof source.productFitBlocked === "boolean" ? source.productFitBlocked : null,
		...
		audienceStage: toCleanString(source.audienceStage),
			...
			canonicalSource,
			canonicalUrl: toCleanString(source.canonicalUrl ?? source.canonicalURL),
			excerpt: toCleanString(source.excerpt),
			publishDate: toCleanString(source.publishDate ?? source.publishedAt),
			externalUrls: toPlainObject(source.externalUrls),
			syndicationStatus: toCleanString(source.syndicationStatus),
			platformIds: toPlainObject(source.platformIds),
